...
export const RecipeDetail: React.FC<RecipeDetailProps> = ({
  ...
  return (
    <Stack spacing="none" className="fixed inset-0 z-50 bg-card animate-in slide-in-from-bottom-10">
      ...
      <div
        data-testid="detail-action-footer"
        className="fixed bottom-0 left-0 right-0 z-50 border-t border-border bg-background/80 px-4 py-3 pb-[calc(0.75rem+env(safe-area-inset-bottom))] backdrop-blur-md transition-all duration-300"
      >
