...
test.describe('Weekly Meal Planning', () => {
  test.beforeEach(async ({ page, context }) => {
    ...
    // Mock Recipes Data
    const mockRecipes = [
        { id: '1', title: 'Chicken Curry', protein: 'Chicken', thisWeek: false, prepTime: 10, cookTime: 20, servings: 4, ingredients: [{name: 'Chicken', amount: '1lb'}], steps: [] },
        { id: '2', title: 'Beef Stew', protein: 'Beef', thisWeek: false, prepTime: 10, cookTime: 20, servings: 4, ingredients: [{name: 'Beef', amount: '1lb'}], steps: [] },
        { id: '3', title: 'Grilled Fish', protein: 'Fish', thisWeek: false, prepTime: 10, cookTime: 20, servings: 4, ingredients: [{name: 'Fish', amount: '1lb'}], steps: [] },
        { id: '4', title: 'Pork Chops', protein: 'Pork', thisWeek: false, prepTime: 10, cookTime: 20, servings: 4, ingredients: [{name: 'Pork', amount: '1lb'}], steps: [] },
        { id: '5', title: 'Chicken Salad', protein: 'Chicken', thisWeek: false, prepTime: 10, cookTime: 20, servings: 4, ingredients: [{name: 'Chicken', amount: '1lb'}], steps: [] },
    ]
