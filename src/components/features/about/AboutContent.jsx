...
const AboutContent = () => {
    ...
    return (
        <div className="animate-in fade-in duration-700 space-y-16">
            ...
            {/* What I Do */}
            <div>
                <Heading variant="heading-l" className="mb-8 border-b-4 border-black pb-2 inline-block">What I Do</Heading>
                <ContentBlock color="bg-white" pin rotate={1} padding="p-8">
                    <div className="flex items-start gap-4 mb-6">
                        <Briefcase className="text-black mt-1" size={32} />
                        <div>
                            <Heading variant="heading-m" className="mb-1">JP Morgan Chase</Heading>
                            <Text variant="body-l" className="font-bold text-gray-700">UX Research Strategist, Operations Team</Text>
                            <Text variant="fine" className="text-gray-500 font-bold uppercase tracking-wider">January 2023 - Present | Austin, TX</Text>
                        </div>
                    </div>
            ...
            {/* How I Work */}
            <div>
                <Heading variant="heading-l" className="mb-8 border-b-4 border-black pb-2 inline-block">How I Work</Heading>
                    ...
                    <ContentBlock color="bg-white" pin rotate={-1} padding="p-8">
                        ...
                        <div className="space-y-6">
                            <ContentBlock padding="p-6" color="bg-white" pin rotate={1}>
                                <Heading variant="heading-s" className="mb-2">Context engineering over prompt engineering.</Heading>
                                <Text variant="body-base">You don't need the perfect prompt. You need the right information. I'd rather spend 10 minutes finding good documentation than an hour trying to word a request perfectly.</Text>
                            </ContentBlock>

                            <ContentBlock padding="p-6" color="bg-white" pin rotate={-1}>
                                <Heading variant="heading-s" className="mb-2">Test everything, trust nothing (at first).</Heading>
                                <Text variant="body-base">The 5×5 framework exists because I refuse to ship things based on hope. 5 runs to check consistency. 5 scenarios to verify accuracy. Simple, repeatable, effective.</Text>
                            </ContentBlock>

                            <ContentBlock padding="p-6" color="bg-white" pin rotate={1}>
                                <Heading variant="heading-s" className="mb-2">Learn publicly, build openly.</Heading>
                                <Text variant="body-base">I write about what I'm stuck on, not just what I've figured out. The shift from "wanting to be right" to "wanting to get it right" changed how I work. I'd rather admit I don't know something than perform expertise I don't have.</Text>
                            </ContentBlock>
                        </div>

                        <Text variant="body-l" className="mt-6 font-bold border-t-2 border-black pt-4">
            ...
            {/* Before This */}
            <div>
                <Heading variant="heading-l" className="mb-8 border-b-4 border-black pb-2 inline-block">Before This</Heading>
                <div className="space-y-6">
                    <ContentBlock color="bg-white" pin rotate={1} padding="p-6">
                        <Heading variant="heading-m" className="mb-1">Charles Schwab</Heading>
                        <Text variant="body-l" className="font-bold text-gray-700">Lead UX Researcher</Text>
                        <Text variant="fine" className="text-gray-500 mb-4 font-bold uppercase">2020-2022 | Austin, TX</Text>
                        <Text variant="body-base">Led usability evaluations and content research that improved user understanding and accelerated content-first design. Identified friction points in client verification that resulted in a +90% fraud prevention rate and $26M quarterly cost avoidance.</Text>
                    </ContentBlock>

                    <ContentBlock color="bg-white" pin rotate={-1} padding="p-6">
                        <Heading variant="heading-m" className="mb-1">HEB</Heading>
                        <Text variant="body-l" className="font-bold text-gray-700">Customer Experience Manager</Text>
                        <Text variant="fine" className="text-gray-500 mb-4 font-bold uppercase">2017-2020 | Austin, TX</Text>
                        <Text variant="body-base">Managed customer experience initiatives and knowledge transfer across the organization.</Text>
                    </ContentBlock>
                </div>
            </div>
            ...
            <div>
                <Heading variant="heading-l" className="mb-8 border-b-4 border-black pb-2 inline-block">Education & Certifications</Heading>
                <ContentBlock color="bg-white" pin rotate={2} padding="p-8">
                    <ul className="space-y-4">
                        {[
                            ...
                            <li key={i} className="flex items-start gap-3 font-bold text-lg font-body">
            ...
            {/* Outside of Work */}
            <div>
                <Heading variant="heading-l" className="mb-8 border-b-4 border-black pb-2 inline-block">Outside of Work</Heading>
                <ContentBlock color="bg-white" pin rotate={-2} padding="p-8">
            ...
            <div className="py-12 border-t-4 border-black">
                <Heading variant="heading-l" className="mb-6">What's Next</Heading>
                ...
                <div className="space-y-6">
                    <div>
                        <Label variant="eyebrow" className="mb-3 text-gray-500">Want to see what I'm working on?</Label>
                    ...
                    <div>
                        <Label variant="eyebrow" className="mb-3 text-gray-500">Looking to collaborate?</Label>
